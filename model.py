...
def inference(images, batch_size, n_classes):
    ...
    with tf.variable_scope('conv1') as scope:
        ...
        biases = tf.Variable(tf.constant(value=0.15, dtype=tf.float32, shape=[64]),
    ...
    with tf.variable_scope('conv2') as scope:
        ...
        biases = tf.Variable(tf.constant(value=0.15, dtype=tf.float32, shape=[16]),
                             name='biases', dtype=tf.float32)
    ...
    with tf.variable_scope('local3') as scope:
        ...
        biases = tf.Variable(tf.constant(value=0.15, dtype=tf.float32, shape=[128]),
                             name='biases', dtype=tf.float32)
